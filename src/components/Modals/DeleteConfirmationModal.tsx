...
export const DeleteConfirmationModal = ({
    ...
    return (
        <AnimatedModal
            isOpen={isOpen}
            onClose={onClose}
            className="relative bg-gradient-to-br from-card-primary to-card-primary/95 border border-red-500/30 rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden"
        >
            {/* Close Button */}
            <button
                onClick={onClose}

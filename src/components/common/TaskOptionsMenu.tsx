    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        className="absolute bg-background-primary right-0 top-full mt-2 w-48 bg-card-dark border border-border-default rounded-lg shadow-2xl overflow-hidden z-50"

        ...
        <div className="relative" ref={menuRef}>
            ...
            {isMenuOpen && (
                <div className="absolute bg-background-primary right-0 top-full mt-2 w-48 bg-card-dark border border-border-default rounded-lg shadow-2xl overflow-hidden z-50">
                    <button
                        onClick={handleEdit}
                        className="w-full px-4 py-3 text-left text-text-primary hover:bg-background-primary-hover transition-colors flex items-center gap-3"
                    >
                    ...
                    <button
                        ...
                        className="w-full px-4 py-3 text-left text-text-primary hover:bg-background-primary-hover transition-colors flex items-center gap-3 border-t border-border-default"
                    >
                    ...
                    <button
                        ...
                        className="w-full px-4 py-3 text-left text-red-400 hover:bg-red-500/10 transition-colors flex items-center gap-3 border-t border-border-default"
                    >
